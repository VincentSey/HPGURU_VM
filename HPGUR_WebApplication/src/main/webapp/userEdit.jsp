...
<fieldset class="form-group">
<label>User Login_userid</label> <input type="text" value="<c:out
value='${user.Login_userid}' />" class="form-control" name="name" required="required">
</fieldset>
<fieldset class="form-group">
<label>User address</label> <input type="text" value="<c:out
value='${user.address}' />" class="form-control" name="name" required="required">
</fieldset>
<fieldset class="form-group">
<label>User reset</label> <input type="text" value="<c:out
value='${user.reset}' />" class="form-control" name="name" required="required">
</fieldset>
